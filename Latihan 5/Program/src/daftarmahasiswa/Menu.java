...
/**
 *
 * @author sekar and modify by : cantika
 */
...
public class Menu extends javax.swing.JFrame 
{
    ...
    */
    public Menu() 
    {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2103727", "Cantika Putri Arbiliansyah", "A", "Perempuan"));
        listMhs.add(new Mahasiswa("2003452", "Aryo Bagas Pamungkas", "B", "Laki-laki"));
        listMhs.add(new Mahasiswa("2001872", "Muhammad Satria", "C", "Laki-laki"));
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblNilai, javax.swing.GroupLayout.Alignment.LEADING))
        ...
        lblGender.getAccessibleContext().setAccessibleDescription("");
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        jGender.setSelectedItem(selectedGender);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (isUpdate == true)
        {
            //MESSAGE UNTUK KONFIRMASI
            int konfirmasi = JOptionPane.showConfirmDialog(null, "Apakah anda yakin?", "Message", JOptionPane.YES_NO_OPTION);
            //JIKA YA
            if(konfirmasi == 0)
            {
                //DELETE
